 ...
 * 
 * Parse behavior (written):
 *  VA -> V, an Adjective modifying a Verb is a Verb
 *  NA -> A, an Adjective modifying a Noun is an Adjective
 ...
 * 0xE - Range/Range
 * 0xF - [Multinibble instructions, as follows]
 * 0xF0 - X/Modulus
 * 0xF10 - 1st Chain
 * 0xF11 - 2nd Chain
 * 0xF12 - 3rd Chain
 * 0xF13 - 4th Chain
 * 0xF14 - N'th Chain after first
 ...
 * 0xFC - Split-Compose
 * 0xFD - Reflex
 * 0xFE - Two-Byte extensions
 * 0xFF - Section break
 *
 * Filter expects a unary verb, Fold expects a binary verb
 * 
 * Noun encoding (0b000yxxxx)
 *  y - Datatype (0=integer, 1=string) (see integer.d)
 *  String type (y=1):
 *    
 * 
 */